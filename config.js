...
export const config = {
  ...
  management: {
    ...
    outOfRangeWaitMinutesUpper: u.outOfRangeWaitMinutesUpper ?? 10,
    outOfRangeWaitMinutesLower: u.outOfRangeWaitMinutesLower ?? 10,
...
export function getDynamicTakeProfitPct() {
  ...
  if (utc7Hour >= 19 || utc7Hour < 2) return 10.0;
  if (utc7Hour >= 2 && utc7Hour < 7) return 10.0;
  if (utc7Hour >= 7 && utc7Hour < 13) return 10.0;
  return 10.0;
}
